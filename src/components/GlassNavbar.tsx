...
const GlassNavbar = () => {
  ...
  return (
    <nav className="fixed bottom-4 md:bottom-8 left-1/2 -translate-x-1/2 sm:-translate-x-[calc(50%+10px)] md:-translate-x-1/2 z-50 animate-fade-up-delay-2 w-auto max-w-[calc(100%-2rem)]">
